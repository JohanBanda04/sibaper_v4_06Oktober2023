                ...
                <form method="post" id="tes" action="add-proses_table.php" class="form-horizontal">
                    <div class="box-body">
                        <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                                <?php
                                $get_nama_pemohon = mysqli_query($koneksi,"select nama_lengkap from `user` where id_user='$_SESSION[user_id]'");
                               // $_SESSION['user_id'];
                                ?>
                                <input type="text" readonly value="<?php echo mysqli_fetch_assoc($get_nama_pemohon)['nama_lengkap']; ?>"
                                       class="form-control"
                                       name="unit" id="unit">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="jenis_brg" class=" col-sm-3 control-label">Jenisz Barang</label>
                            <div class="col-sm-6">
                                <select id="jenis_brg" required="isikan dulu" class="form-control" name="id_jenis">
                                    ...
                                    if (mysqli_num_rows($queryJenis)) {
                                        while ($row = mysqli_fetch_assoc($queryJenis)){
                                            if($row['jenis_brg']!="ALAT KEBERSIHAN" && $row['jenis_brg'] !="PERLENGKAPAN LAINNYA"){
                                                ?>
                        ...
                        <div class="form-group">
                            ...
                            <label for="nama_brg" class="col-sm-3 control-label">Namaz Barang</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <a href="index.php?p=datapesanan_table" style="margin:10px;" class="btn btn-success"><i
...
AND status_acc='Permintaan Baru'");
                        ...
                        <td>
                            <a href="hapusps_table.php?id=<?php echo $row['id_sementara']; ?>" class="btn btn-danger"
                ...
                <div class="box-body">
                    ...
                    <!--ini original tombol minta barang tidak digunakan-->
                    <?php if ($cekdata != 0) { ?>
