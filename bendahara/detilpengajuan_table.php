...
where pengajuan_sementara.tgl_pengajuan='$tgl_pengajuan' and pengajuan_sementara.unit='$nama_lengap_pengaju' 
        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Input Barang Maasuk</h3>
                    <h3 class="text-center" style="font-weight: bold"> <?php echo $unit; ?></h3>
                </div>
                <div class="box-body">
                    <a href="index.php?p=datapengajuan_table&pas=datapengajuan" style="margin:10px;" class="btn btn-success">
                        <i class='fa fa-backward'>
                            Kembali
                        </i>
                    </a>
                    <div class="table-responsive">
                        <table class="table text-center" id="detilpengajuan_table_operator">
                            <thead>
                            <tr>
                                <th>No</th>
                                <th>IPS</th>
                                ...
                                while ($row = mysqli_fetch_assoc($query)):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form style="alignment: center" method="post"
                                                  action="setujuipengajuanbarang_table.php">
                                                <!--lanjut pemberian rata tengah utk tombol 'MMasukan Ke Stok Barang'-->
                                                <input class="hidden" type="text" name="id_pengajuan"
                                                       value="<?php echo $row['id_pengajuan']; ?>">
                                                <input class="hidden" type="text" name="id_pengajuan_sementara"
...
<script>
    ...
    $(function () {
        $("#detilpengajuan_table_operator").DataTable({
            "language": {
