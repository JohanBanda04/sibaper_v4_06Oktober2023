        ...
        <div class="col-sm-12 col-xs-18">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">FForm Pengajuan Barang</h3>
                </div>
                <form method="post" id="tes"  action="simpan_pengajuansementara.php" class="form-horizontal">
                    <div class="box-body">
                        <div class="form-group ">
                            ...
                            <div class="col-sm-3">
                                <?php
                                $query_get_nama_pengelola = mysqli_query($koneksi, "Select nama_lengkap from `user` where id_user='$_SESSION[user_id]'");
                                ?>
                                <input type="text" readonly value="<?php echo mysqli_fetch_assoc($query_get_nama_pengelola)['nama_lengkap']; ?>"
