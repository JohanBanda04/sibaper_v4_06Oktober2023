        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    ?>
                    <h3 class="text-center">Data Pengeluaran Barang untuk <b><?php echo mysqli_fetch_assoc($query_get_nama_pemohon)['nama_lengkap']; ?></b></h3>
                </div>
                <div class="box-body">
                    <div class="table-responsive">
                        <a href="index.php?p=datapengeluaran_table&pas=datapermintaanbarang" style="margin:10px;" class="btn btn-success"><i class='fa fa-backward'>  Kembali</i></a>
                    </div>

                    <table class="table table-bordered table-hover text-center" id="detil_datapengeluaran_side_operator">
                        <thead  >
                        <tr>
                            <th>No</th>
...
<script>
    ...
    $(function () {
        $("#detil_datapengeluaran_side_operator").DataTable({
            "language": {
