    ...
    <div class="row">
        <div class="col-sm-12 col-xs-18">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Rekapitulasi Permintaan Barangs</h3>
                </div>
        ...
        if(isset($_SESSION['sesi_kode_barang_lengkap'])){
            if($_SESSION['sesi_kode_barang_lengkap']!=""){
                ...
                $query_get_nama_brg = mysqli_query($koneksi,"select nama_brg from stokbarang where kode_brg='$_SESSION[sesi_kode_barang_lengkap]'");
                //cara fetch 1 /single data dari database
                //cara fetch 1 /single value dari database
                $row = mysqli_fetch_assoc($query_get_nama_brg);
                $nama_barang = $row['nama_brg'];
                //BENAHI DISINI
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <div class="form-group">
                        ...
                        ?>
                        <div class="col-md-12">
                            <form method="POST" action='cetak_lap_rekapitulasipermintaan.php' target="_blank" class="form-inline">
                                <div class="form-group">
                                    <label> Periode</label>
                            ...
                            <form method="POST" action='rekapitulasipermintaan_excel.php' target="_blank" class="form-inline">
...
<!--                                </div>-->
                            ...
                            <!--<a href="rekapitulasipermintaan_excel.php" target="_blank"
                               class="btn btn-primary" style="position: absolute; right: 40px; top: 0px">Download Excel
                            </a>-->
                        </div>
                    </div>
...
and permintaan.unit='$unit'");
                ...
                window.location='index.php?p=rekapitulasipermintaan'</script>
                ";}
...
<script>
    ...
    $(function () {
        $("#rekapitulasipermintaan_operator").DataTable({
            "language": {
